...
function homePage() {
  ...
  return [
    ...
    '<div class="home-hero__visual"><figure class="hero-photo hero-photo--main"><img src="assets/images/brand/rachel-sticker.webp" srcset="assets/images/brand/rachel-sticker-560.webp 560w, assets/images/brand/rachel-sticker.webp 1087w" sizes="(max-width: 780px) calc(100vw - 32px), min(39vw, 610px)" width="1087" height="1447" alt="Rachel, stylist at Esencia Hair Studio" fetchpriority="high" decoding="async"></figure><div class="hero-stamp"><span>Personalised</span><strong>for you</strong></div></div>',
